...
const StatusCard = ({ 
  ...
  const getStatusColors = () => {
    switch (status) {
      case 'success': return { bg: '#dcfce7', iconBg: '#dcfce7', iconColor: '#16a34a', textColor: '#16a34a' }
      case 'error': return { bg: '#fee2e2', iconBg: '#fee2e2', iconColor: '#dc2626', textColor: '#dc2626' }
      default: return { bg: '#dbeafe', iconBg: '#dbeafe', iconColor: '#2563eb', textColor: '#111827' }
    }
  }
