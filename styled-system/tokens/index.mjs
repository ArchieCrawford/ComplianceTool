const tokens = {
  ...
  "colors.border.light": {
    "value": "#f1f5f9",
    "variable": "var(--colors-border-light)"
  },
  "colors.text.heading": {
    "value": "#111827",
  ...
  "colors.status.pass": {
    "value": "#10b981",
    "variable": "var(--colors-status-pass)"
  },
  "colors.status.fail": {
    "value": "#ef4444",
    "variable": "var(--colors-status-fail)"
  },
  ...
  "colors.colorPalette.sidebar": {
    "value": "var(--colors-color-palette-sidebar)",
    "variable": "var(--colors-color-palette-sidebar)"
  },
  ...
  "colors.colorPalette.pass": {
    "value": "var(--colors-color-palette-pass)",
    "variable": "var(--colors-color-palette-pass)"
  },
  "colors.colorPalette.fail": {
    "value": "var(--colors-color-palette-fail)",
    "variable": "var(--colors-color-palette-fail)"
  },
